...
const SyllabusAndAffiliations = () => {
  const cmsData = {
    content: [
      ...
      {
        type: "p",
        text: "Blessing Home Public School focuses on strong foundations in English, Urdu, Mathematics, Science, Islamiat, and general knowledge through clear teaching and regular practice.",
      },
      {
        type: "h3",
