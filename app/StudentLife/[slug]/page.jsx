...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${studentLife.title} - Student Life | Blessing Home Public School`,
    default: "Student Life | Blessing Home Public School",
  };
}
...
const cmsContentBySlug = {
  OLevel: [
    ...
    {
      type: "p",
      text: "The admission process at Blessing Home Public School is designed to be simple and parent-friendly. Families can contact the school office, share the student's basic details, and receive guidance about the relevant class and admission requirements.",
    },
    {
      type: "p",
  ...
  Primary: [
    ...
    {
      type: "p",
      text: "In the primary years, Blessing Home Public School creates a nurturing and engaging environment where students develop strong academic foundations alongside social and emotional growth.",
    },
    {
      type: "p",
...
const StudentLife = async ({ params }) => {
  ...
  return (
    <main>
      <HeroHeader title={studentLife.title} description="Blessing Home Public School" />
