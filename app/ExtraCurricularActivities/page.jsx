...
const ExtraCurricularActivities = () => {
  const cmsData = {
    content: [
      {
        type: "p",
        text: "At Blessing Home Public School, learning extends beyond the classroom. Co-curricular activities help students discover confidence, teamwork, creativity, and healthy habits.",
      },
      { type: "br" },
      {
        type: "h5",
