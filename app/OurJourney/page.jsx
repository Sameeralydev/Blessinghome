...
const OurJourney = () => {
  const cmsData = {
    content: [
      ...
      {
        type: "p",
        text: "Blessing Home Public School was established with the purpose of serving families in Pakpattan through accessible, caring, and meaningful education.",
      },
      {
        type: "br",
      },
  ...
  return (
    <main>
      <HeroHeader title={"Our Journey"} description="Blessing Home Public School" />
