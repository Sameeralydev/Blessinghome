...
const SocietyAndClubs = () => {
  const cmsData = {
    content: [
      ...
      {
        type: "p",
        text: "Blessing Home Public School values learning beyond the classroom. Our student life activities are designed to help children build confidence, teamwork, discipline, and healthy expression.",
      },
      {
        type: "br",
      },
