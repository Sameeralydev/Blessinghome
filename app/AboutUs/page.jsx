...
const AboutUs = () => {
  const cmsData = {
    content: [
      ...
      {
        type: "p",
        text: "Blessing Home Public School is committed to providing quality education in a safe and caring environment where children can build academic strength, confidence, discipline, and respect for others.",
      },
      {
        type: "br",
      },
  ...
  return (
    <main>
      <HeroHeader title={"About"} description="Blessing Home Public School" />
