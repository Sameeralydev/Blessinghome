...
const List = [
  ...
  },
  {
    ...
    slug: "/Curriculum/UpperMiddleYearsOLevel",
  },
  {
    title: ["Upper", "Middle Years", "Matriculation"],
    slug: "/Curriculum/UpperMiddleYearsMatriculation",
  },
];

const Curriculum = ({ direction, speed }) => {
  ...
  return (
    ...
    >
      <h2 className="max-sm:px-4 h2 text-center">
        Check Our <br />
        <span className="text-main">Curriculum</span>
      </h2>
