  ...
  const Steps = [
    {
      ...
      detail: [
        "At Blessing Home Public School, we believe every child deserves respectful guidance, thoughtful teaching, and a school atmosphere that feels safe, structured, and encouraging.",
      ...
      <div className="w-fit flex-shrink-0 px-6 py-8 sm:px-12 sm:py-12 relative">
        <div className="sticky top-28 flex flex-col max-lg:items-center max-lg:text-center">
          <h2 className="h2 w-fit">
            Blessing Home <br className="max-sm:hidden" />
            <span>
