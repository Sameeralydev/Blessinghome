  ...
  return (
    ...
    >
      <h2 className="h2 text-center">
        Welcome to <span className="text-main">Blessing Home</span> Public School
      </h2>
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <div className="sm:[grid-area:2/2/3/3] xl:[grid-area:1/3/3/4] min-h-72 rounded-3xl bg-slate-100 overflow-hidden relative">
          <Image
            ...
            width="800"
            height="800"
            alt="Blessing Home Public School students"
          ...
          <div className="absolute bottom-0 left-0 right-0 z-40 p-6">
            <div className="rounded-2xl bg-white/90 backdrop-blur px-4 py-3 text-sm sm:text-base text-dark max-w-[28rem]">
              A welcoming school atmosphere where children learn, participate,
        ...
        <div className="sm:[grid-area:3/1/4/3] xl:[grid-area:2/2/3/3] group/card min-h-72 p-6 rounded-3xl bg-main relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col gap-4">
            ...
            <p className="text-base sm:text-lg text-light">
              Blessing Home Public School envisions a future where every child
